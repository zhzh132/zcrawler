...
public class TLDList {
  ...
  private TLDList() {
    try {
      ...
      logger.warn(String.format("Couldn't fetch the online list of TLDs from: {%s}", TLD_NAMES_ONLINE_URL));
      logger.info(String.format("Fetching the list from my local file {%s}", TLD_NAMES_TXT_FILENAME));
